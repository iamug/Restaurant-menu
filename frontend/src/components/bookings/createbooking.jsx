  ...
  const handleSelectVehicle = async () => {
    ...
    if (vehicles && vehicles.vehicle)
      vehicles.vehicle.forEach((e) => {
        dataArray = [...dataArray, { label: e.car.name, value: e.car.name }];
      });
            ...
            <div className="row mt-3">
              <div className="col-6">
                ...
                <div className="form-group col-sm-12 row">
                  ...
                  <div className="col-sm-7">
                    <DatePicker name="bookingDate" oneTap block />
                  </div>
                </div>
              </div>
              <div className="col-6">
                    ...
                    <div className="row mb-2">
                      ...
                      <div className="col-sm-7">
                        <div className="text-sm-right">
                          <button
                            type="button"
                            className="btn btn-blue btn-sm waves-effect waves-light mb-2"
                          >
