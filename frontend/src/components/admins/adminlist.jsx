...
const AdminListComponent = (props) => {
  ...
  let [rolesData, setRolesData] = useState(false);
  ...
  const handleSelectRole = async () => {
    ...
    if (rolesdata) {
      ...
      rolesdata.forEach((e) => {
        e.isEnabled &&
          (dataArray = [...dataArray, { label: e.name, value: e._id }]);
      });
    }
    setRoles(dataArray);
  };
        ...
        <Drawer.Body>
          <Form
            ...
            onSubmit={(data) => {
              ...
              dataUpdate ? updateadmins(formValue.adminId) : addadmin();
            }}
            onChange={(data) => {
              console.log({ data });
              console.log({ formValue });
                ...
                <Col xs={12}>
                  <FormGroup>
                    ...
                    <FormControl
                      ...
                      data={roles}
                      onOpen={handleSelectRole}
                      onSearch={handleSelectRole}
                      renderMenu={(menu) => {
                        if (!handleSelectRole) {
                          return (
                            <p
