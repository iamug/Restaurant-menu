...
export const hasModulePermission = {
  read: (data, module) => {
    if (
      ...
      (data && data[module] && data[module].read)
    )
      return true;
    return false;
  },
  create: (data, module) => {
    if (
      (data && data.superAdmin) ||
      (data && data[module] && data[module].create)
    )
      return true;
    return false;
  },
  update: (data, module) => {
    if (
      (data && data.superAdmin) ||
      (data && data[module] && data[module].update)
    )
      return true;
    return false;
  },
  delete: (data, module) => {
    if (
      (data && data.superAdmin) ||
      (data && data[module] && data[module].delete)
    )
      return true;
    return false;
  },
...
const hasReadPermission = (module, permissions, superAdmin = false) => {
  ...
  if (
    superAdmin ||
    (permissions && permissions[module] && permissions[module].read)
  ) {
    return true;
  } else {
    return false;
